...
export default function Navbar() {
  ...
  return (
    <motion.nav
      ...
      className={`${
        scrolled ? "border-b-0" : "border-b border-gray-200/15"
      } fixed top-0 left-0 w-full z-50 font-space-grotesk bg-dev`}
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between h-full border-dev">
        {/* Left: Logo + Navigation */}
        <div className="px-6 md:px-2 lg:px-6 flex items-center space-x-4 lg:space-x-8 xl:space-x-20">

          <div className="text-4xl md:text-2xl lg:text-4xl font-bold text-blue-600 flex flex-col  font-logo">
              ...
              return (
                <div key={label} className="relative group">
                  <Link
                    ...
                    } uppercase font-primary text-sm lg:text-base font-medium transition`}
                  >
                    {label}
                  </Link>
                  <span
